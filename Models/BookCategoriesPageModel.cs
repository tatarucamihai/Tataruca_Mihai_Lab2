...
namespace Tataruca_Mihai_Lab2.Models
{ 
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Tataruca_Mihai_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Tataruca_Mihai_Lab2Context context,
